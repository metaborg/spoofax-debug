...
{ 
  ...
  { 
    ...
    { 
      ...
      m_8 = localvar.const0;
      q_8 = p_8;
      n_8 = localvar.const40;
      r_8 = q_8;
      term = r_enter_0_3.instance.invoke(context, r_8, m_8, n_8, localvar.constLocationInfo19);
      if(term == null)
        break Fail6;
      s_8 = l_8;
      x_8 = h_8;
      t_8 = localvar.const0;
      y_8 = x_8;
      u_8 = localvar.const40;
      z_8 = y_8;
      v_8 = localvar.const44;
      a_9 = z_8;
      term = s_var_0_4.instance.invoke(context, a_9, t_8, u_8, v_8, localvar.constLocationInfo20);
      if(term == null)
        break Fail6;
      term = s_8;
      b_9 = s_8;
      ...
      { 
        ...
        { 
          ...
          c_9 = localvar.const0;
          g_9 = f_9;
          d_9 = localvar.const40;
          h_9 = g_9;
          term = s_step_0_3.instance.invoke(context, h_9, c_9, d_9, localvar.constLocationInfo21);
          if(term == null)
            break Fail7;
          l_9 = h_8;
          i_9 = localvar.const0;
          m_9 = l_9;
          j_9 = localvar.const40;
          n_9 = m_9;
          term = s_step_0_3.instance.invoke(context, n_9, i_9, j_9, localvar.constLocationInfo22);
          if(term == null)
            break Fail7;
          ...
          u_9 = localvar.const0;
          z_9 = y_9;
          v_9 = localvar.const40;
          a_10 = z_9;
          w_9 = localvar.const48;
          b_10 = a_10;
          term = s_var_0_4.instance.invoke(context, b_10, u_9, v_9, w_9, localvar.constLocationInfo24);
          if(term == null)
            break Fail7;
          if(true)
            break Success3;
        ...
        k_8 = term;
        d_10 = j_8;
        term = report_with_failure_0_2.instance.invoke(context, d_10, localvar.const49, k_8);
        if(term == null)
          break Fail6;
      }
      term = b_9;
      if(i_8 == null)
        break Fail6;
      h_10 = i_8;
      e_10 = localvar.const0;
      i_10 = h_10;
      f_10 = localvar.const40;
      j_10 = i_10;
      term = r_exit_0_3.instance.invoke(context, j_10, e_10, f_10, localvar.constLocationInfo19);
      if(term == null)
        break Fail6;
