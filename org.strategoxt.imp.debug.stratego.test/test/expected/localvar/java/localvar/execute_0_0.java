...
{ 
  ...
  { 
    ...
    { 
      ...
      z_2 = localvar.const9;
      d_3 = c_3;
      term = r_enter_0_3.instance.invoke(context, d_3, y_2, z_2, localvar.constLocationInfo3);
      if(term == null)
        break Fail2;
      e_3 = x_2;
      j_3 = t_2;
      ...
      g_3 = localvar.const9;
      l_3 = k_3;
      h_3 = localvar.const13;
      m_3 = l_3;
      term = s_var_0_4.instance.invoke(context, m_3, f_3, g_3, h_3, localvar.constLocationInfo4);
      if(term == null)
        break Fail2;
      term = e_3;
      n_3 = e_3;
      ...
      { 
        ...
        { 
          ...
          p_3 = localvar.const9;
          t_3 = s_3;
          term = s_step_0_3.instance.invoke(context, t_3, o_3, p_3, localvar.constLocationInfo5);
          if(term == null)
            break Fail3;
          x_3 = t_2;
          u_3 = localvar.const0;
          ...
          v_3 = localvar.const9;
          z_3 = y_3;
          term = s_step_0_3.instance.invoke(context, z_3, u_3, v_3, localvar.constLocationInfo6);
          if(term == null)
            break Fail3;
          ...
          b_4 = localvar.const9;
          g_4 = f_4;
          c_4 = localvar.const18;
          h_4 = g_4;
          term = s_var_0_4.instance.invoke(context, h_4, a_4, b_4, c_4, localvar.constLocationInfo7);
          if(term == null)
            break Fail3;
          if(true)
            break Success1;
        ...
        w_2 = term;
        j_4 = v_2;
        term = report_with_failure_0_2.instance.invoke(context, j_4, localvar.const20, w_2);
        if(term == null)
          break Fail2;
      }
      term = n_3;
      ...
      l_4 = localvar.const9;
      p_4 = o_4;
      term = r_exit_0_3.instance.invoke(context, p_4, k_4, l_4, localvar.constLocationInfo3);
      if(term == null)
        break Fail2;
