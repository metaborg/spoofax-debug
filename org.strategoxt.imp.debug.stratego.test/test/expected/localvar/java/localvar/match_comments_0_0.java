...
{ 
  ...
  { 
    ...
    { 
      ...
      z_4 = localvar.const0;
      d_5 = c_5;
      a_5 = localvar.const21;
      e_5 = d_5;
      term = r_enter_0_3.instance.invoke(context, e_5, z_4, a_5, localvar.constLocationInfo8);
      if(term == null)
        break Fail4;
      f_5 = y_4;
      k_5 = s_4;
      g_5 = localvar.const0;
      l_5 = k_5;
      h_5 = localvar.const21;
      m_5 = l_5;
      i_5 = localvar.const25;
      n_5 = m_5;
      term = s_var_0_4.instance.invoke(context, n_5, g_5, h_5, i_5, localvar.constLocationInfo9);
      if(term == null)
        break Fail4;
      term = f_5;
      o_5 = f_5;
      ...
      { 
        ...
        { 
          ...
          p_5 = localvar.const0;
          t_5 = s_5;
          q_5 = localvar.const21;
          u_5 = t_5;
          term = s_step_0_3.instance.invoke(context, u_5, p_5, q_5, localvar.constLocationInfo10);
          if(term == null)
            break Fail5;
          y_5 = s_4;
          v_5 = localvar.const0;
          z_5 = y_5;
          w_5 = localvar.const21;
          a_6 = z_5;
          term = s_step_0_3.instance.invoke(context, a_6, v_5, w_5, localvar.constLocationInfo11);
          if(term == null)
            break Fail5;
          ...
          b_6 = localvar.const0;
          g_6 = f_6;
          c_6 = localvar.const21;
          h_6 = g_6;
          d_6 = localvar.const33;
          i_6 = h_6;
          term = s_var_0_4.instance.invoke(context, i_6, b_6, c_6, d_6, localvar.constLocationInfo12);
          if(term == null)
            break Fail5;
          m_6 = term;
          j_6 = localvar.const0;
          n_6 = m_6;
          k_6 = localvar.const21;
          o_6 = n_6;
          term = s_step_0_3.instance.invoke(context, o_6, j_6, k_6, localvar.constLocationInfo13);
          if(term == null)
            break Fail5;
          s_6 = s_4;
          p_6 = localvar.const0;
          t_6 = s_6;
          q_6 = localvar.const21;
          u_6 = t_6;
          term = s_step_0_3.instance.invoke(context, u_6, p_6, q_6, localvar.constLocationInfo14);
          if(term == null)
            break Fail5;
          ...
          v_6 = localvar.const0;
          a_7 = z_6;
          w_6 = localvar.const21;
          b_7 = a_7;
          x_6 = localvar.const35;
          c_7 = b_7;
          term = s_var_0_4.instance.invoke(context, c_7, v_6, w_6, x_6, localvar.constLocationInfo15);
          if(term == null)
            break Fail5;
          g_7 = term;
          d_7 = localvar.const0;
          h_7 = g_7;
          e_7 = localvar.const21;
          i_7 = h_7;
          term = s_step_0_3.instance.invoke(context, i_7, d_7, e_7, localvar.constLocationInfo16);
          if(term == null)
            break Fail5;
          ...
          j_7 = localvar.const0;
          n_7 = m_7;
          k_7 = localvar.const21;
          o_7 = n_7;
          term = s_step_0_3.instance.invoke(context, o_7, j_7, k_7, localvar.constLocationInfo17);
          if(term == null)
            break Fail5;
          ...
          p_7 = localvar.const0;
          u_7 = t_7;
          q_7 = localvar.const21;
          v_7 = u_7;
          r_7 = localvar.const38;
          w_7 = v_7;
          term = s_var_0_4.instance.invoke(context, w_7, p_7, q_7, r_7, localvar.constLocationInfo18);
          if(term == null)
            break Fail5;
          if(true)
            break Success2;
        ...
        x_4 = term;
        y_7 = w_4;
        term = report_with_failure_0_2.instance.invoke(context, y_7, localvar.const39, x_4);
        if(term == null)
          break Fail4;
      }
      term = o_5;
      ...
      z_7 = localvar.const0;
      d_8 = c_8;
      a_8 = localvar.const21;
      e_8 = d_8;
      term = r_exit_0_3.instance.invoke(context, e_8, z_7, a_8, localvar.constLocationInfo8);
      if(term == null)
        break Fail4;
