...
{ 
  ...
  { 
    compiledContext.registerComponent("localvar");
    localvar.init(compiledContext);
    varScope.addSVar("main_0_0", new InteropSDefT(classLoader, "localvar.main_0_0", context));
    varScope.addSVar("execute_0_0", new InteropSDefT(classLoader, "localvar.execute_0_0", context));
    varScope.addSVar("match_comments_0_0", new InteropSDefT(classLoader, "localvar.match_comments_0_0", context));
    varScope.addSVar("find_functions_0_0", new InteropSDefT(classLoader, "localvar.find_functions_0_0", context));
    varScope.addSVar("find_comments_0_0", new InteropSDefT(classLoader, "localvar.find_comments_0_0", context));
    varScope.addSVar("match_f_and_c_0_0", new InteropSDefT(classLoader, "localvar.match_f_and_c_0_0", context));
    varScope.addSVar("try_find_comment_by_name_0_1", new InteropSDefT(classLoader, "localvar.try_find_comment_by_name_0_1", context));
    varScope.addSVar("find_comment_match_0_1", new InteropSDefT(classLoader, "localvar.find_comment_match_0_1", context));
    varScope.addSVar("get_function_name_0_0", new InteropSDefT(classLoader, "localvar.get_function_name_0_0", context));
    varScope.addSVar("find_comment_by_name_0_1", new InteropSDefT(classLoader, "localvar.find_comment_by_name_0_1", context));
    varScope.addSVar("is_empty_0_0", new InteropSDefT(classLoader, "localvar.is_empty_0_0", context));
    varScope.addSVar("first_0_0", new InteropSDefT(classLoader, "localvar.first_0_0", context));
    varScope.addSVar("build_c_0_0", new InteropSDefT(classLoader, "localvar.build_c_0_0", context));
  }
}