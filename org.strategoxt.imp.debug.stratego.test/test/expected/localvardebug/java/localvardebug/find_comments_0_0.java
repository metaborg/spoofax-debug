...
{ 
  ...
  { 
    ...
    { 
      ...
      q_10 = term;
      u_10 = term;
      r_10 = localvardebug.const0;
      v_10 = u_10;
      s_10 = localvardebug.const50;
      w_10 = v_10;
      term = r_enter_0_3.instance.invoke(context, w_10, r_10, s_10, localvardebug.constLocationInfo25);
      if(term == null)
        break Fail8;
      x_10 = q_10;
      c_11 = m_10;
      y_10 = localvardebug.const0;
      d_11 = c_11;
      z_10 = localvardebug.const50;
      e_11 = d_11;
      a_11 = localvardebug.const44;
      f_11 = e_11;
      term = s_var_0_4.instance.invoke(context, f_11, y_10, z_10, a_11, localvardebug.constLocationInfo26);
      if(term == null)
        break Fail8;
      term = x_10;
      g_11 = x_10;
      ...
      { 
        ...
        { 
          ...
          k_11 = term;
          h_11 = localvardebug.const0;
          l_11 = k_11;
          i_11 = localvardebug.const50;
          m_11 = l_11;
          term = s_step_0_3.instance.invoke(context, m_11, h_11, i_11, localvardebug.constLocationInfo27);
          if(term == null)
            break Fail9;
          q_11 = m_10;
          n_11 = localvardebug.const0;
          r_11 = q_11;
          o_11 = localvardebug.const50;
          s_11 = r_11;
          term = s_step_0_3.instance.invoke(context, s_11, n_11, o_11, localvardebug.constLocationInfo28);
          if(term == null)
            break Fail9;
          ...
          n_10 = term;
          d_12 = term;
          z_11 = localvardebug.const0;
          e_12 = d_12;
          a_12 = localvardebug.const50;
          f_12 = e_12;
          b_12 = localvardebug.const55;
          g_12 = f_12;
          term = s_var_0_4.instance.invoke(context, g_12, z_11, a_12, b_12, localvardebug.constLocationInfo30);
          if(term == null)
            break Fail9;
          if(true)
            break Success4;
        ...
        p_10 = term;
        i_12 = o_10;
        term = report_with_failure_0_2.instance.invoke(context, i_12, localvardebug.const56, p_10);
        if(term == null)
          break Fail8;
      }
      term = g_11;
      if(n_10 == null)
        break Fail8;
      m_12 = n_10;
      j_12 = localvardebug.const0;
      n_12 = m_12;
      k_12 = localvardebug.const50;
      o_12 = n_12;
      term = r_exit_0_3.instance.invoke(context, o_12, j_12, k_12, localvardebug.constLocationInfo25);
      if(term == null)
        break Fail8;
